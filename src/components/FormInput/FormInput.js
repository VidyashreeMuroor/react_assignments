...
<form onSubmit={onSubmitHandler} className="form">
        <div className="input-group">
          ...
          <p>
            ...
            <input onChange={(event)=>inputChangeHandler('yearly-contribution', event.target.value)} value={userInput['yearly-contribution']} 
        ...
        <p className="actions">
          <button onClick={onClickHandler} type="reset" className="buttonAlt">
            Reset
          </button>
